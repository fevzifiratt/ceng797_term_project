//
// Generated file, do not edit! Created by opp_msgtool 6.2 from HelloMessage.msg.
//
...
HelloMessage::HelloMessage(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}
...
int HelloMessage::getSenderId() const
{
    return this->senderId;
}

void HelloMessage::setSenderId(int senderId)
{
    this->senderId = senderId;
}

int HelloMessage::getColor() const
{
    return this->color;
}

void HelloMessage::setColor(int color)
{
    this->color = color;
}

int HelloMessage::getRole() const
{
    return this->role;
}

void HelloMessage::setRole(int role)
{
    this->role = role;
}
...
HelloMessageDescriptor::HelloMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(HelloMessage)), "omnetpp::cPacket")
{
...
int HelloMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "color") == 0) return baseIndex + 1;
...
int HelloMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    HelloMessage *pp = omnetpp::fromAnyPtr<HelloMessage>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void HelloMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    HelloMessage *pp = omnetpp::fromAnyPtr<HelloMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'HelloMessage'", field);
    }
}

const char *HelloMessageDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string HelloMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void HelloMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'HelloMessage'", field);
    }
}

omnetpp::cValue HelloMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'HelloMessage' as cValue -- field index out of range?", field);
    }
}

void HelloMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::any_ptr HelloMessageDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void HelloMessageDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
